...
<div class="container" >
    <div style=display:flex;align-items:center;">
        <div class="col-md-8"><h2 style="text-align: center">${msetion.name}</h2></div>
        <div style="text-align:center; margin:0 auto;padding-top: 10px" class="col-md-4">
            <a href="javascript:void(0)" id="addcourse"><button  type="button" class="btn btn-primary">添加课程</button></a>
            ...
            <a href="<%=basePath%>course/messageboard/${course.id}/locat/${msetion.id}"><button type="button" class="btn btn-primary">留言版</button></a>
        </div>
    </div>
			...
			<div class="col-md-8">
				<div >
				    ...
				    <div style="text-align:center; margin:0 auto;">
				        <a target="aaa" href="<%=basePath%>course/video/${msetion.id}" id="moren"><button  type="button" class="btn btn-primary">视频观看</button></a>
				        <a target="aaa" href="<%=basePath%>homework/option/${msetion.id}" id="Chapterdetection"><button type="button" class="btn btn-primary">章节检测</button></a>
				    </div>
				    <iframe name="aaa" width="100%" height="500" style="border: 0px;margin-top: 20px;" scrolling="no" id="myiframe">
				    </iframe>
				</div>
			</div>
            <div class="col-md-4" >
